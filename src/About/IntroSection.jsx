      ...
      <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center md:space-x-10">
        ...
        >
          ...
          <motion.p
            ...
            viewport={{ once: true }}
          >
            Abhishek Mukherjee is the driving force behind AI Bricks Realtors, a
            brand built on innovation, trust, and excellence in modern real
            estate. With a clear vision to revolutionize the property landscape,
            Abhishek brings together architectural precision, cutting-edge
            technology, and human-centered design to redefine how people
            experience living spaces.
          </motion.p>
          ...
          >
            ...
            ensuring that every project reflects quality, sustainability, and
            thoughtful craftsmanship. His forward-thinking approach blends
